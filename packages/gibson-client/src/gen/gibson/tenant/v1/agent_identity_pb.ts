...
// @generated from file gibson/tenant/v1/agent_identity.proto (package gibson.tenant.v1, syntax proto3)
/* eslint-disable */

// Package gibson.tenant.v1 — AgentIdentityService: customer-callable machine
// identity provisioning surface. Extracted from the monolithic TenantService
...
export const ComponentGrantSchema: GenMessage<ComponentGrant> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 0);
...
export const CreateAgentIdentityRequestSchema: GenMessage<CreateAgentIdentityRequest> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 1);
...
export const CreateAgentIdentityResponseSchema: GenMessage<CreateAgentIdentityResponse> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 2);
...
export const ListAgentIdentitiesRequestSchema: GenMessage<ListAgentIdentitiesRequest> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 3);
...
export const AgentIdentitySchema: GenMessage<AgentIdentity> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 4);
...
export const ListAgentIdentitiesResponseSchema: GenMessage<ListAgentIdentitiesResponse> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 5);
...
export const RevokeAgentIdentityRequestSchema: GenMessage<RevokeAgentIdentityRequest> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 6);
...
export const RevokeAgentIdentityResponseSchema: GenMessage<RevokeAgentIdentityResponse> = /*@__PURE__*/
  messageDesc(file_gibson_tenant_v1_agent_identity, 7);
...
export const PrincipalKindSchema: GenEnum<PrincipalKind> = /*@__PURE__*/
  enumDesc(file_gibson_tenant_v1_agent_identity, 0);

/**
 * AgentIdentityService provisions and manages machine identities for agents,
 * tools, and plugins.
 *
 * @generated from service gibson.tenant.v1.AgentIdentityService
 */
export const AgentIdentityService: GenService<{
   ...
   *
   * @generated from rpc gibson.tenant.v1.AgentIdentityService.ListAgentIdentities
   */
  listAgentIdentities: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc gibson.tenant.v1.AgentIdentityService.RevokeAgentIdentity
   */
  revokeAgentIdentity: {
    methodKind: "unary";
  ...
  serviceDesc(file_gibson_tenant_v1_agent_identity, 0);
